 ...
 *
 * Deliberately unrelated to the app's own sign-in (email/password) — every
 * account connects to Odoo with whatever real Odoo login it saves here, so
 * OdooPlus accounts are free to use any email/password of their own without
 * needing to match an Odoo user.
 */
